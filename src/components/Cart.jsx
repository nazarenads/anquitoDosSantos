          ...
          <div class="sticky space-y-4 rounded-sm border border-neutral-200 bg-white py-6 px-4 shadow-sm sm:px-6 md:w-1/3">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="mt-auto flex flex-col gap-2 pt-4">
                <div class="">
                  <Link to='/checkout' href="#" class="flex items-center justify-center rounded-md border border-transparent bg-neutral-800 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-neutral-900">Go to checkout</Link>
                </div>
